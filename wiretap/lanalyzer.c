/* lanalyzer.c
 *
 * $Id: lanalyzer.c 27683 2009-03-09 21:18:55Z gerald $
 *
 * Wiretap Library
...
int lanalyzer_open(wtap *wth, int *err, gchar **err_info)
{
	...
	wth->capture.lanalyzer = g_malloc(sizeof(lanalyzer_t));					// BUG_5EA75897(1) FIX_5EA75897(1) #CWE-415 #Allocate memory to pointer "wth->capture.lanalyzer"
