...
val_to_str(guint32 val, const value_string *vs, const char *fmt) {
  ...
  ret = match_strval(val, vs); // BUG_B11C16A5(3) FIX_B11C16A5(3) #Call function "match_strval"
  if (ret != NULL)
    return ret;
...
match_strval_idx(guint32 val, const value_string *vs, gint *idx) {
  ...
  if(vs) {
    while (vs[i].strptr) {		// BUG_B11C16A5(5) FIX_B11C16A5(5) #CWE-788 #Overreads buffer "vs" if it lacks a null terminator
      if (vs[i].value == val) {		// BUG_B11C16A5(6) FIX_B11C16A5(6) #CWE-788 #Overreads buffer "vs" if it lacks a null terminator
        *idx = i;
        return(vs[i].strptr);		// BUG_B11C16A5(7) FIX_B11C16A5(7) #CWE-788 #Overreads buffer "vs" if it lacks a null terminator
      }
      i++;
    }
  }
...
match_strval(guint32 val, const value_string *vs) {
    gint ignore_me;
    return match_strval_idx(val, vs, &ignore_me); // BUG_B11C16A5(4) FIX_B11C16A5(4) #Call function "match_strval_idx"
}
