 ...
 *
 * $Id: packet-ntlmssp.c 28356 2009-05-13 19:46:11Z etxrab $
 *
			   ...
			   proto_tree *ntlmssp_tree, ntlmssp_header_t *ntlmssph _U_)
{
  ...
  ntlmssp_info *conv_ntlmssp_info;			// BUG_A751D662(1) FIX_A751D662(1) #CWE-824 #Declare pointer "conv_ntlmssp_info" without initializing it.
