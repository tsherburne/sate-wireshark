 ...
 *
 * $Id: packet-icmpv6.c 28052 2009-04-14 18:31:02Z wmeier $
 *
...
dissect_icmpv6ndopt(tvbuff_t *tvb, int offset, packet_info *pinfo, proto_tree *tree)
{
	...
	guint8 name_type = 0;
	guint8 cert_type = 0;
	asn1_ctx_t asn1_ctx;																// BUG_848E3C4E(1) FIX_848E3C4E(1) #CWE-457 #Declare structure "asn1_ctx" with initializing it
	guint32 lifetime;
	guint32 no_of_pars;
	guint32 i;
