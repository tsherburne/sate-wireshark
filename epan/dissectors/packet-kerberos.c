 ...
 *
 * $Id: packet-kerberos.c 28363 2009-05-14 19:28:07Z etxrab $
 *
...
{
    return (dissect_kerberos_common(tvb, pinfo, tree, do_col_info, FALSE, FALSE, cb));	// BUG_419BD03E(2) FIX_419BD03E(2) #CWE-119 #Passing pointer "cb", which can be NULL, as last parameter of function "dissect_kerberros_common"
}
...
dissect_kerberos_udp(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
    ...
    */
    ...
    return dissect_kerberos_common(tvb, pinfo, tree, TRUE, TRUE, FALSE, NULL);		// BUG_419BD03E(3) FIX_419BD03E(3) #CWE-119 #Passing NULL as last parameter "cb" of function "dissect_kerberros_common"
}
...
dissect_kerberos_tcp_pdu(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
    ...
    if (dissect_kerberos_common(tvb, pinfo, tree, TRUE, TRUE, TRUE, NULL) < 0) {	// BUG_419BD03E(4) FIX_419BD03E(4) #CWE-119 #Passing NULL as last parameter "cb" of function "dissect_kerberros_common"
	/*
    ...
    kerberos_callbacks *cb)
{
    ...
    saved_private_data=pinfo->private_data;					// BUG_419BD03E(5) FIX_419BD03E(5) #Save pointer "pinfo->private_data" with "cb" to "saved_private_data"
    pinfo->private_data=cb;							// BUG_419BD03E(6) FIX_419BD03E(6) #Initialize pointer "pinfo->private_data" with "cb", which can be NULL
    do_col_info=dci;
				 ...
				 proto_tree *tree, guint8 *drep _U_)
{
	...
	dissect_kerberos_main(auth_tvb, pinfo, tree, FALSE, NULL);			// BUG_419BD03E(1) FIX_419BD03E(1) #CWE-119 #Passing NULL as last parameter "cb" of function "dissect_kerberros_main"
