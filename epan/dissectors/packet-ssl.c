 ...
 *
 * $Id: packet-ssl.c 28356 2009-05-13 19:46:11Z etxrab $
 *
...
const gchar* ssl_version_short_names[] = {						// BUG_2AB010E1(1) FIX_2AB010E1(1) #CWE-126 #Declaration of array "ssl_version_short_names", which might be missing entries
  "SSL",
  "SSLv2",
  "SSLv3",
  "TLSv1",
...
dissect_ssl(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
    ...
    while (tvb_reported_length_remaining(tvb, offset) != 0)
    {
        ...
        case SSL_VER_TLS:
            ...
            {
                offset = dissect_ssl3_record(tvb, pinfo, ssl_tree,			// BUG_2AB010E1(2) FIX_2AB010E1(3) #5 #Index "conv_version" can be set to "SSL_VER_TLSv1DOT2" in function "dissect_ssl3_record"
                                             offset, conv_version,
                                             &need_desegmentation,
                                             ssl_session,
        ...
        default:
            ...
            else if (ssl_looks_like_sslv3(tvb, offset))
            {
                ...
                offset = dissect_ssl3_record(tvb, pinfo, ssl_tree,			// BUG_2AB010E1(3) FIX_2AB010E1(4) #5 #Index "conv_version" can be set to "SSL_VER_TLSv1DOT2" in function "dissect_ssl3_record"
                                             offset, conv_version,
                                             &need_desegmentation,
                                             ssl_session,
                                             first_record_in_frame);
            ...
            else
            {
                ...
                if (check_col(pinfo->cinfo, COL_PROTOCOL))
                {
                    col_set_str(pinfo->cinfo, COL_PROTOCOL,
                         ssl_version_short_names[*conv_version]);			// BUG_2AB010E1(9) FIX_2AB010E1(10) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
                }
            }
            break;
        }
                    ...
                    SslDecryptSession* ssl, gboolean first_record_in_frame _U_)
{
    ...
    if ((*conv_version==SSL_VER_TLS || *conv_version==SSL_VER_TLSv1DOT1 || *conv_version==SSL_VER_TLSv1DOT2) &&
      ...
      if (check_col(pinfo->cinfo, COL_PROTOCOL))
          col_set_str(pinfo->cinfo, COL_PROTOCOL, ssl_version_short_names[*conv_version]);	// BUG_2AB010E1(10) FIX_2AB010E1(11) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread 
   ...
   /*
    ...
    version       = tvb_get_ntohs(tvb, offset + 1);					// BUG_2AB010E1(4) FIX_2AB010E1(5) #Number "version" is read from the packet
    ...
    if (ssl_is_valid_content_type(content_type)) {
        ...
        {
            col_set_str(pinfo->cinfo, COL_PROTOCOL,
                        ssl_version_short_names[*conv_version]);			// BUG_2AB010E1(11) FIX_2AB010E1(12) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
        }
        ...
        && ssl_is_authoritative_version_message(content_type, next_byte))
    {
        ...
        else if (version == TLSV1DOT2_VERSION)						// BUG_2AB010E1(5) FIX_2AB010E1(6) #Assume "version" equals "TLSV1DOT2_VERSION"
        {

            *conv_version = SSL_VER_TLSv1DOT2;						// BUG_2AB010E1(6) FIX_2AB010E1(7) #CWE-126 #Set index "conv_version" to "SSL_VER_TLSv1DOT2", which might be greater than the size of array "ssl_version_short_names", which "conv_version" indexes, if entry "TLSv1.2" is missing from the array
            if (ssl) {
                ssl->version_netorder = version;
                ssl->state |= SSL_VERSION;
                ssl_debug_printf("dissect_ssl3_record found version 0x%04X -> state 0x%02X\n", ssl->version_netorder, ssl->state);
    ...
    {
            col_set_str(pinfo->cinfo, COL_PROTOCOL,
                        ssl_version_short_names[*conv_version]);			// BUG_2AB010E1(7) FIX_2AB010E1(8) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
    }
    ...
    case SSL_ID_APP_DATA:
        ...
        proto_item_set_text(ssl_record_tree,
           "%s Record Layer: %s Protocol: %s",
            ssl_version_short_names[*conv_version],					// BUG_2AB010E1(8) FIX_2AB010E1(9) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
                                ...
                                guint* conv_version, guint8 content_type)
{
    ...
    if (tree)
    {
        proto_item_set_text(tree,
                            ...
                            ssl_version_short_names[*conv_version],			// BUG_2AB010E1(12) FIX_2AB010E1(13) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
                            val_to_str(content_type, ssl_31_content_type, "unknown"));
    ...
    if (tree)
    {
        if (level && desc)
        {
            proto_item_set_text(tree, "%s Record Layer: Alert "
                                ...
                                ssl_version_short_names[*conv_version],			// BUG_2AB010E1(13) FIX_2AB010E1(14) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread	
                                level, desc);
        ...
        else
        {
            proto_item_set_text(tree,
                                ...
                                ssl_version_short_names[*conv_version]);		// BUG_2AB010E1(14) FIX_2AB010E1(15) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
        ...
        if (tree)
        {
            ...
            if (first_iteration)
            {
                proto_item_set_text(tree, "%s Record Layer: %s Protocol: %s",
                                    ssl_version_short_names[*conv_version],		// BUG_2AB010E1(15) FIX_2AB010E1(16) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
                                    val_to_str(content_type, ssl_31_content_type, "unknown"),
            ...
            {
                proto_item_set_text(tree, "%s Record Layer: %s Protocol: %s",
                                    ssl_version_short_names[*conv_version],		// BUG_2AB010E1(16) FIX_2AB010E1(17) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
                                    val_to_str(content_type, ssl_31_content_type, "unknown"),
