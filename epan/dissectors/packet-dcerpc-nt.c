 ...
 *
 * $Id: packet-dcerpc-nt.c 26649 2008-10-31 15:47:47Z stig $
 *
				  ...
				  pol_hash_value **valuep)
{
	...
	if ((*valuep = g_hash_table_lookup(pol_hash, &key))) {		// BUG_C58965E4(3) FIX_C58965E4(3) #CWE-476 #The return pointer of function "g_hash_table_lookup" can be null (if the key is not in the table) and is assigned to pointer "valuep"
		/*
			   ...
			   pol_value *pol, pol_hash_value *value)
{
	...
	if (value == NULL) {						// BUG_C58965E4(5) FIX_C58965E4(5) #If pointer "value" is null, take this branch.
		/*
...
{
	pol_hash_value *value;						// BUG_C58965E4(1) FIX_C58965E4(1) #Declare pointer "value" without initializing it.
	pol_value *pol;
	...
	pol = find_pol_handle(policy_hnd, pinfo->fd->num, &value);	// BUG_C58965E4(2) FIX_C58965E4(2) #CWE-476 #Pass pointer "value" to function "find_pol_handle", which can set it to NULL.
	...
	add_pol_handle(policy_hnd, pinfo->fd->num, pol, value);		// BUG_C58965E4(4) FIX_C58965E4(4) #Pass potentially null pointer "value" to function "add_pol_handle"
}
