 ...
 *
 * Martin Mathieson
 * $Id: packet-umts_fp.h 25425 2008-06-04 17:33:48Z martinm $
 *
...
#define MAX_FP_CHANS  64
    gint chan_tf_size[MAX_FP_CHANS];	// BUG_8926DD0C(1) FIX_8926DD0C(1) #2 #Fields "chan_tf_size" and "chan_num_tbs" are declared as arrays of size "MAX_FP_CHANS"
    gint chan_num_tbs[MAX_FP_CHANS];

#define MAX_EDCH_DDIS 16
    gint   no_ddi_entries;
    guint8 edch_ddi[MAX_EDCH_DDIS];	// BUG_F66DF60F(1) FIX_F66DF60F(1) #2 #Fields "edch_ddi" and "edch_macd_pdu_size" are declared as arrays of size "MAX_EDCH_DDIS"
