 ...
 *
 * $Id: packet-x509af.c 28379 2009-05-16 22:07:03Z stig $
 *
...
#line 80 "x509af.cnf"
  offset=call_ber_oid_callback(algorithm_id, tvb, offset, actx->pinfo, tree);										// BUG_848E3C4E(3) FIX_848E3C4E(4) #CWE-457 #Pass address of field "pinfo" from potentially uninitialized structure "actx" to function "call_ber_oid_callback"
