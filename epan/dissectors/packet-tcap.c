 ...
 *
 * $Id: packet-tcap.c 28379 2009-05-16 22:07:03Z stig $
 *
...
dissect_tcap_param(asn1_ctx_t *actx, proto_tree *tree, tvbuff_t *tvb, int offset)
{
	...
	offset = get_ber_identifier(tvb, offset, &class, &pc, &tag);				// BUG_7169C840(7) FIX_7169C840(7) #Potentially invalid pointer "tvb" (was "next_tvb" in caller) is passed to function "get_ber_identifier".
	tag_offset = offset;
