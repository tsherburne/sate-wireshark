 ...
 *
 * $Id: packet-infiniband.c 28273 2009-05-05 03:50:06Z guy $
 *
...
{
    gint32 i;
    for(i = 0; i < length; i++)																// BUG_E31410C9(13) FIX_E31410C9(13) #Loop until "i" reaches "length", which might be larger than the size of "Codes"
    {
        if((OpCode ^ Codes[i]) == 0)															// BUG_E31410C9(14) FIX_E31410C9(14) #CWE-126 #Read from "Codes" at index "i", which may lead to an overread
            return TRUE;
    }
    return FALSE;
}
