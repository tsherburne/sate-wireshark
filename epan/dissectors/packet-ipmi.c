 ...
 *
 * $Id: packet-ipmi.c 27994 2009-04-08 13:07:21Z wmeier $
 *
...
ipmi_do_dissect(tvbuff_t *tvb, proto_tree *ipmi_tree, ipmi_dissect_format_t *dfmt)
{
	...
	if (ipmi_tree) {
		...
		if (tvb_length(data_tvb) && hnd) {
			...
			hnd(data_tvb, data_tree);							// BUG_28B3BB4B(3) FIX_28B3BB4B(3) #Call function "rs2b" through function pointer "hnd"
		}
