 ...
 *
 * $Id: packet-dtls.c 28356 2009-05-13 19:46:11Z etxrab $
 *
...
extern const gchar *ssl_version_short_names[];						// BUG_2AB010E1(18) FIX_2AB010E1(19) #CWE-126 #Declaration of external array "ssl_version_short_names", which might be missing entries 
                    ...
                    SslDecryptSession* ssl)
{
  ...
  case SSL_ID_APP_DATA:
    ...
    proto_item_set_text(dtls_record_tree,
			...
			ssl_version_short_names[*conv_version],				// BUG_2AB010E1(19) FIX_2AB010E1(20) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
  ...
  if (tree)
    {
      proto_item_set_text(tree,
			  ...
			  ssl_version_short_names[*conv_version],			// BUG_2AB010E1(20) FIX_2AB010E1(21) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
			  val_to_str(content_type, ssl_31_content_type, "unknown"));
  ...
  if (tree)
    {
	  ...
	  proto_item_set_text(tree, "%s Record Layer: Alert "
			      ...
			      ssl_version_short_names[*conv_version],			// BUG_2AB010E1(21) FIX_2AB010E1(22) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
			      level, desc);
	  ...
	  proto_item_set_text(tree,
			      ...
			      ssl_version_short_names[*conv_version]);			// BUG_2AB010E1(22) FIX_2AB010E1(23) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
      ...
      if (fragmented)
	{
	  ...
	  if (first_iteration)
	      ...
	      proto_item_set_text(tree, "%s Record Layer: %s Protocol: %s%s",
				  ssl_version_short_names[*conv_version],		// BUG_2AB010E1(23) FIX_2AB010E1(24) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
				  val_to_str(content_type, ssl_31_content_type, "unknown"),
            ...
            {
	      proto_item_set_text(tree, "%s Record Layer: %s Protocol: %s%s",
				  ssl_version_short_names[*conv_version],		// BUG_2AB010E1(24) FIX_2AB010E1(25) #CWE-126 #Alternative location where index "conv_version" might be greater than the size of array "ssl_version_short_names", causing an overread
				  val_to_str(content_type, ssl_31_content_type, "unknown"),
