 ...
 *
 * $Id: packet-cdp.c 28091 2009-04-20 05:49:26Z jake $
 *
...
dissect_cdp(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
    ...
    int addr_length;
    guint32 ip_addr;
    vec_t cksum_vec[1];										// BUG_3723B848(1) FIX_3723B848(1) #Declare array "chksum_vec"
    ...
    computed_checksum = in_cksum(cksum_vec, 1);							// BUG_3723B848(3) FIX_3723B848(3) #Pass array "chksum_vec" to function "in_chksum()"
