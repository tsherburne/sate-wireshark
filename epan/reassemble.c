 ...
 *
 * $Id: reassemble.c 27718 2009-03-13 22:06:48Z stig $
 *
	     ...
	     guint32 frag_data_len, gboolean more_frags)
{
	...
	fd->offset = frag_offset;									// BUG_8C32D803(3) FIX_8C32D803(3) #Set "fd->offset" to possible large value of "frag_offset"
	...
	if (fd_head->flags & FD_DEFRAGMENTED) {
		...
		else if ( memcmp(fd_head->data+fd->offset,						// BUG_8C32D803(5) FIX_8C32D803(5) #4 #CWE-823 #CWE-126 #Add possibly large offset "fd->offset" to pointer "fd_head->data", making it point out of range, and pass it to function "memcmp", causing the reading of invalid memory
